...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    @Query(value = "SELECT * FROM post WHERE author LIKE %:criteria% OR content LIKE %:criteria% OR title LIKE" +
            " %:criteria%", nativeQuery = true)
    List<Post> getPostByRemainingCriteria(String criteria);
}
